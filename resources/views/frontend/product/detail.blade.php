	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
                                ...
                                <div class="item-slick3" data-thumb="{{ URL::to('/')}}/uploads/images/products/{{ $img }}">
									<div class="wrap-pic-w pos-relative">
										<img src="{{ URL::to('/')}}/uploads/images/products/{{ $img }}" alt="{{ $img }}">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ URL::to('/')}}/uploads/images/products/{{ $img }}">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2">
							${{ number_format($infoProduct->price) }}
						</span>
		...
		<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
			<span class="stext-107 cl6 p-lr-25">
				Name's product: {{ $infoProduct->name }}
			</span>

			<span class="stext-107 cl6 p-lr-25">
				Categories: {{ $infoProduct->category_name }}
			</span>
		</div>
	</section>
    <!-- Related Products -->
						...
						<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
							...
							<div class="block2">
								<div class="block2-pic hov-img0">
									<img src="{{ URL::to('/') }}/uploads/images/products/{{ $product->image }}" alt="{{ $product->name }}"> 
		...
		$(function(){
			$('.js-addcart-detail').click(function(){
				...
				if(
					...
					swal("Message", "Choose color, size and quantity, please !", "error");
				}
			});
		});
	</script>
